...
<form action="{{ url('client') }}" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data" validate>
@csrf
  ...
  <div class="col-md-4">
    ...
    <input type="number" class="form-control" id="validationCustom01" name="saldo" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
