...
@section('main-title', 'Panel de clasificaciones')
@section('navbar-menu')

<aside>
    <a href="{{url('/classification/create')}}" class="btn btn-primary btn-lg" tabindex="-1" role="button">Crear</a>
</aside>
...
<table class="table table-hover table-responsive">
  ...
  <tbody>
    ...
    <td>{{ $classification -> nombre_clasificacion }}</td>
